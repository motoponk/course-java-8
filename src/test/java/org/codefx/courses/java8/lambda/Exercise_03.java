...
public class Exercise_03 {
	...
	private ListCruncher<String> listLength = null;

	/** Computes the sum of the lengths of the strings in the list. */
	private ListCruncher<String> stringLengths = null;
